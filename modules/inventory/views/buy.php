<?php
/**
 * @filesource modules/inventory/views/buy.php
...
class View extends \Gcms\View
{
  ...
  public function render($index, $login)
  {
    ...
    $form = Html::create('form', array(
        ...
        'class' => 'setup_frm',
        'autocomplete' => 'off',
        'action' => 'index.php/inventory/model/buy/submit',
        'onsubmit' => 'doFormSubmit',
        'ajax' => true,
        'token' => true,
    ));
    $fieldset = $form->add('fieldset', array(
      'title' => '{LNG_Details of} {LNG_Supplier}',
    ...
    $groups->add('text', array(
      ...
      'itemClass' => 'width90',
      'label' => '{LNG_Supplier}<span class=tablet> (F2)</span>',
    ...
    $groups->add('button', array(
      ...
      'label' => '&nbsp;',
      'value' => '<span class=mobile>{LNG_Add New} {LNG_Supplier}</span>',
    ));
    $fieldset = $form->add('fieldset', array(
    ...
    $groups->add('text', array(
      ...
      'itemClass' => 'width50',
      'label' => '{LNG_Number of transactions}',
    ...
    foreach (\Inventory\Stock\Model::get($index->id, 'IN') as $item) {
    ...
    // Javascript
    $form->script('initInventoryInOut('.self::$cfg->vat.', "buy");');
    // คืนค่าฟอร์ม
    return $form->render();
  }
}
