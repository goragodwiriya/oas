...
if (defined('ROOT_PATH')) {
    ...
    echo '</ul>';
    echo '<p class="submit"><a href="index.php?step=1" class="btn large btn-secondary">ตรวจสอบใหม่</a>&nbsp;<a href="index.php?step=2" class="btn large btn-primary">ดำเนินการต่อ</a></p>';
}
 ...
 * @return bool
 */
function makeDirectory(string $dir, $mode = 0755)
: bool {
    if (!is_dir($dir)) {
        $old = umask(0);
        @mkdir($dir, $mode, true);
